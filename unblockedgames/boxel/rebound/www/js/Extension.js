...
function checkExtension(){
    ...
    if (chrome.extension.ViewType.TAB == "tab" &&
        ...
        if (chrome.extension) {
            if((navigator.userAgent.indexOf("Opera") || navigator.userAgent.indexOf('OPR')) != -1) {
                ...
                socialURL = 'https://microsoftedge.microsoft.com/addons/detail/boxel-rebound/icjmhhdmoccaalnjnalamfnfddbeaoke';
            }
            else if(navigator.userAgent.indexOf("Chrome") != -1) {
                socialURL = 'https://chromewebstore.google.com/detail/boxel-rebound/iginnfkhmmfhlkagcmpgofnjhanpmklb/reviews';
            }
            else if(navigator.userAgent.indexOf("Safari") != -1) {
                
            }
            else if(navigator.userAgent.indexOf("Firefox") != -1) {
                socialURL = 'https://addons.mozilla.org/en-US/firefox/addon/boxel-rebound-game/'
            }
        ...
        //create listeners
        document.getElementById("status").addEventListener("click", function(){ chrome.tabs.create({ url: 'https://chrome.google.com/webstore/detail/tiny-tycoon/bamdkjfjhhnjcgcjmmjdnncpglihepoi' }); });
    ...
    else if (getUrlParameter("fullscreen") == 'true') {
        window.clock.render();
    }
    updateFastModeButton();
    checkInspector();
