$(document).ready(function(){
    ...
    function startTimer(duration = 300, callback = function(){}) {
        var rate = 1000;
    ...
    function submitLogin(e) {
        ...
        if (username == 'dopplercreative') { updateValidation('Please use <strong><em>your</em></strong> Youtube account name'); }
        else { checkUsername(); }
    }
    ...
    $('#popup .link, #popup .youtube-container').on('click', function(e){
        ...
        if ($(this).hasClass('youtube-container')) {
            ...
            href = 'https://www.youtube.com/@dopplercreative/videos';
            chrome.tabs.create({ url: href });
        }

        // Show instructions and start timer
        $('.instructions').removeClass('invisible');
        startTimer(300, function() { // 5 minutes
